...
public class Activity4_Screen4 extends Activity
{
			...
			protected void onCreate(Bundle savedInstanceState) 
			{
				...
				b1.setOnClickListener(new OnClickListener() 
				{
					...
					public void onClick(View arg0) 
					{
						...
						**/
						Intent i= new Intent(Activity4_Screen4.this,Activity3_Screen3.class);
						startActivity(i);
				...
				b2.setOnClickListener(new OnClickListener() 
				{
					...
					public void onClick(View arg0) 
					{
						...
						Intent i= new Intent(Activity4_Screen4.this,Activity2_Screen2.class);
						startActivity(i);
				...
				b3.setOnClickListener(new OnClickListener() 
				{
					...
					public void onClick(View arg0) 
					{
						...
						Intent i= new Intent(Activity4_Screen4.this,Activity1_Screen1.class);
						startActivity(i);
					}
				});
			}
